...
$out_dir = "$out_base_dir/sre_10sec_test";
...
open(IN_TRIALS, "<", "$db_base/keys/10sec-10sec.trialkey.csv") or die "cannot open trials list";
...
open(WAVLIST, "<", "$db_base/trials/10sec-10sec.ndx") or die "cannot open wav list";
