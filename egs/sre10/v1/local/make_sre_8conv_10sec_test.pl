...
# Apache 2.0.
# Usage: make_sre_10sec_test.pl /export/corpora5/SRE/SRE2010/eval/ data/.
...
$out_dir = "$out_base_dir/sre_8conv_10sec_test";
...
open(IN_TRIALS, "<", "$db_base/keys/8conv-10sec.trialkey.csv") or die "cannot open trials list";
...
open(WAVLIST, "<", "$db_base/trials/8conv-10sec.ndx") or die "cannot open wav list";
