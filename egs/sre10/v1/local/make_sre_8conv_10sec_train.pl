...
# Apache 2.0.
# Usage: make_sre_10sec_train.pl /export/corpora5/SRE/SRE2010/eval/ data/.
...
$out_dir = "$out_base_dir/sre_8conv_10sec_train";
...
open(WAVLIST, "<", "$db_base/train/8conv.trn") or die "cannot open wav list";
