...
mfccdir=`pwd`/mfcc
set -e
fisher_path=/scratch/njzheng/DATA/fisher/LDC2016E82

# the next command produces the data in local/train_all_asr
local/dnn/fisher_data_prep.sh /scratch/njzheng/DATA/fisher/LDC2016E82/LDC2004T19 \
  /scratch/njzheng/DATA/fisher/LDC2016E82/LDC2005T19 \
  /scratch/njzheng/DATA/fisher/LDC2016E82/LDC2004S13 \
  /scratch/njzheng/DATA/fisher/LDC2016E82/LDC2005S13
