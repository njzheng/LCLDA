...
run.pl ${lda_ivec_dir}/log/lplda.log \
    ...
    "ark:ivector-normalize-length scp:${lda_ivec_dir}/ivector.scp ark:- |" \
      ...
      ${lda_ivec_dir}/transform_lplda.mat || exit 1;
fi
...
run.pl $scores_dir/log/lplda_scoring.log \
  ...
  "ark:ivector-normalize-length scp:${enroll_ivec_dir}/spk_ivector.scp ark:- |
    ivector-transform ${lda_ivec_dir}/transform_lplda.mat ark:- ark:- |
    ivector-normalize-length ark:- ark:- |" \
  "ark:ivector-normalize-length scp:${test_ivec_dir}/ivector.scp ark:- | ivector-transform ${lda_ivec_dir}/transform_lplda.mat ark:- ark:- | ivector-normalize-length ark:- ark:- |" \
