...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    while (std::getline(ki.Stream(), line)) {
      ...
      plda.TransformIvector(plda_config,  ivector_ln11,  num_examples,
                             train_ivector1);
      plda.TransformIvector(plda_config,  ivector_ln12,  num_examples,
                             train_ivector2);
      num_examples = 1;
      plda.TransformIvector(plda_config, ivector_ln21, num_examples,
                                                     test_ivector1);  
      plda.TransformIvector(plda_config, ivector_ln22, num_examples,
                                                     test_ivector2);
